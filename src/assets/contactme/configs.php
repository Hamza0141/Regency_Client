...
$configs['from_address']			= 'hamzaserke@gmail.com';						// Your email address used to send emails
$configs['to_addresses']			= array('hamzaserke@gmail.com');					// The addresse(s) where to send all the requests
/* END - Required Config */
